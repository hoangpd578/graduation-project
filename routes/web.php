...
Route::group(['middleware' => ['get.menu']], function () {
    Route::get('/admin', 'admin\EmployeeController@index')->name('admin.employee.index')->middleware('admin');
    Route::get('/', 'EmployeeController@index')->name('employee.index');
    Route::get('/timesheet/{id}', 'EmployeeController@show')->name('employee.show');
